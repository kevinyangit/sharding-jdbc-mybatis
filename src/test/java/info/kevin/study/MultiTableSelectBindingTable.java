 ...
 * @see
 */
public final class MultiTableSelectBindingTable {
	...
	private static ShardingDataSource getOrderShardingDataSource() {
		...
		// .build();
		BindingTableRule bindingTableRule = new BindingTableRule(Arrays.asList(orderTableRule,orderItemTableRule));
		ShardingRule shardingRule = new ShardingRule(dataSourceRule, Arrays.asList(orderTableRule, orderItemTableRule),
				Collections.singleton(bindingTableRule),
				new DatabaseShardingStrategy("user_id", new ModuloDatabaseShardingAlgorithm()),
				new TableShardingStrategy("order_id", new ModuloTableShardingAlgorithm()));
//		new ShardingRule(dataSourceRule, Arrays.asList(orderTableRule, orderItemTableRule),
//				new DatabaseShardingStrategy("user_id", new ModuloDatabaseShardingAlgorithm()),
//				new TableShardingStrategy("order_id", new ModuloTableShardingAlgorithm()));
